  ...
  return (
    <main className="mx-auto flex min-h-[70vh] w-full max-w-xl flex-1 items-center px-5 py-12">
      <section className="w-full rounded-3xl border border-white/10 bg-[#10101f] p-6 text-center shadow-2xl">
        ...
        <h1 className="mt-4 font-display text-xl font-bold text-white">That screen hit a temporary problem</h1>
        <p className="mt-2 text-sm leading-6 text-slate-400">
          Your learning data has not been changed. Try the screen again, or return to the dashboard.
        </p>
