...
export const onboardingMn: Record<OnboardingKeys, string> = {
  ...
  'onboarding.level.testTitle': 'Түвшнээ тогтоох',
  'onboarding.level.testBody': '10 богино асуултад хариулаад тохирох эхлэх түвшнээ аваарай.',
  'onboarding.level.startTest': 'Түвшин тогтоох тест эхлэх',
  ...
  'onboarding.placement.resultBody': 'Та {total} асуултаас {score}-д нь зөв хариуллаа. Дараа нь түвшнээ өөрчилж болно.',
