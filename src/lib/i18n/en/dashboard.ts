...
export const dashboardEn = {
  ...
  'dashboard.mobileMenu.closeAria': 'Close menu',
  'dashboard.mobileMenu.workspace': 'Workspace',
  'dashboard.mobileMenu.navigationAria': 'More navigation',
  'dashboard.mobileMenu.plan': 'Plan',
  'dashboard.mobileMenu.personalization': 'Personalization',
  'dashboard.mobileMenu.profile': 'Profile',
  'dashboard.mobileMenu.stats': 'Statistics',
  'dashboard.mobileMenu.help': 'Help',
  'dashboard.mobileMenu.helpCenter': 'Help center',
  'dashboard.mobileMenu.releaseNotes': 'Release notes',
  'dashboard.mobileMenu.downloadApp': 'Download app',
  'dashboard.mobileMenu.terms': 'Terms of Service',
  'dashboard.mobileMenu.privacy': 'Privacy Policy',
  'dashboard.mobileMenu.reportBug': 'Report a bug',
  'dashboard.mobileMenu.account': 'Account',
  'dashboard.mobileMenu.defaultUser': 'AudioRepeat user',
  'dashboard.mobileMenu.logout': 'Log out',
